...
//@synthesize productDescription,productPice,productImage,productCategory,createdAt,updatedAt;
...
+(id)productOfDescription:(NSString*)productDescrption category:(NSString*)productCategory price:(NSNumber*)productPrice url:(NSString*)imageUrl  createdDate:(NSDate*)createdAt updatedDate:(NSDate*)updatedAt{
    ...
    newProduct.productPice=productPrice;
...
-(void)submitProduct:(UIImage*)productImage{
    ...
    NSNumber *price=self.productPice;
    ...
    [query findObjectsInBackgroundWithBlock:^(NSArray *objects, NSError *error) {
        ...
        if (error) {
            ...
            for(AVObject *object in objects) {
                ...
                Product *newProduct = [Product productOfDescription:productDescription category:productCategory price:productPrice url:imageUrl createdDate:createdAt updatedDate:updatedAt];
